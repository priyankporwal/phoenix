...
public class GenericKeyValueBuilder extends KeyValueBuilder {
    ...
    private KeyValue build(ImmutableBytesWritable row, ImmutableBytesWritable family, ImmutableBytesWritable qualifier,
        ...
        return new KeyValue(ImmutableBytesPtr.copyBytesIfNecessary(row), ImmutableBytesPtr.copyBytesIfNecessary(family), ImmutableBytesPtr.copyBytesIfNecessary(qualifier),
                ts, type, value == null ? null : ImmutableBytesPtr.copyBytesIfNecessary(value));
    }
