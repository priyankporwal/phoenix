...
public class TableSamplerPredicate implements Predicate<byte[]> {
    ...
    public static TableSamplerPredicate of(final Double tableSamplingRateRaw) {
        assert(tableSamplingRateRaw != null):
        "tableSamplingRate can not be null";
        assert(tableSamplingRateRaw >= 0d && tableSamplingRateRaw <= 100d):
        "tableSamplingRate input has to be a rational number between 0 and 100";
    ...
    final private boolean evaluateWithChance(final int hashcode) {
        ...
        "hashcode should be re-distribute into 0 to 100";
