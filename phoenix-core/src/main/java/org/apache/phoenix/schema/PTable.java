...
public interface PTable extends PMetaDataEntity {
...

    {
        ...
        public static ImmutableStorageScheme fromSerializedValue (
...

    {
        ...
        public static QualifierEncodingScheme fromSerializedValue (
        byte serializedValue){
         ...
         * scheme to decode the correct int value.
         */
        private static int getReservedQualifier ( byte[] bytes, int offset,
        int length){
