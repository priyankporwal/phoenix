...
public class IndexMaintainerTest  extends BaseConnectionlessQueryTest {
    ...
    private void testIndexRowKeyBuilding(String schemaName, String tableName, String dataColumns,
        ...
        try {
            ...
            List<org.apache.phoenix.hbase.index.IndexMaintainer> c1 = org.apache.phoenix.hbase.index.IndexMaintainer.deserialize(ptr, builder, true);
            assertEquals(1,c1.size());
            org.apache.phoenix.hbase.index.IndexMaintainer im1 = c1.get(0);
   ...
   @Test
    ...
    public void tesIndexedExpressionSerialization() throws Exception {
        ...
        try {
            ...
            ImmutableBytesWritable ptr = new ImmutableBytesWritable();
            table.getIndexMaintainers(ptr, pconn);
            List<org.apache.phoenix.hbase.index.IndexMaintainer> indexMaintainerList = org.apache.phoenix.hbase.index.IndexMaintainer.deserialize(ptr, GenericKeyValueBuilder.INSTANCE, true);
