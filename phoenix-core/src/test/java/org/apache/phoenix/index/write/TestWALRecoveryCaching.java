...
import org.apache.phoenix.index.util.TestIndexManagementUtil;
import org.apache.phoenix.index.write.recovery.PerRegionIndexWriteCache;
import org.apache.phoenix.index.write.recovery.StoreFailuresInCachePolicy;
...
@Ignore("Configuration issue - valid test, just needs fixing")
  ...
  public void testWaitsOnIndexRegionToReload() throws Exception {
    ...
    org.apache.phoenix.index.covered.ColumnGroup columns = new org.apache.phoenix.index.covered.ColumnGroup(indexedTableName);
    columns.add(new org.apache.phoenix.index.covered.CoveredColumn(family, qual));
    org.apache.phoenix.index.covered.CoveredColumnIndexSpecifierBuilder builder = new org.apache.phoenix.index.covered.CoveredColumnIndexSpecifierBuilder();
